...
import lib.adapter.PictureImageGridAdapter;
import lib.animators.AlphaInAnimationAdapter;
import lib.animators.AnimationType;
import lib.animators.SlideInBottomAnimationAdapter;
import lib.config.PictureConfig;
import lib.config.PictureMimeType;
import lib.config.PictureSelectionConfig;
import lib.decoration.GridSpacingItemDecoration;
import lib.dialog.PhotoItemSelectedDialog;
import lib.dialog.PictureCustomDialog;
import lib.entity.LocalMedia;
import lib.entity.LocalMediaFolder;
import lib.entity.MediaExtraInfo;
import lib.listener.OnAlbumItemClickListener;
import lib.listener.OnItemClickListener;
import lib.listener.OnPermissionDialogOptionCallback;
import lib.listener.OnPhotoSelectChangedListener;
import lib.listener.OnQueryDataResultListener;
import lib.listener.OnRecyclerViewPreloadMoreListener;
import lib.manager.UCropManager;
import lib.observable.ImagesObservable;
import lib.permissions.PermissionChecker;
import lib.tools.AlbumUtils;
import lib.tools.AttrsUtils;
import lib.tools.BitmapUtils;
import lib.tools.CameraFileUtils;
import lib.tools.DateUtils;
import lib.tools.DoubleUtils;
import lib.tools.JumpUtils;
import lib.tools.MediaUtils;
import lib.tools.PictureFileUtils;
import lib.tools.ScreenUtils;
import lib.tools.SdkVersionUtils;
import lib.tools.SortUtils;
import lib.tools.StringUtils;
import lib.tools.ToastUtils;
import lib.tools.ValueOf;
import lib.widget.FolderPopWindow;
import lib.widget.RecyclerPreloadView;
import ucrop.UCrop;
...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private void loadAllMediaData() {
        if (PermissionChecker
                .checkSelfPermission(this, Build.VERSION.SDK_INT >= 33 ? Manifest.permission.READ_MEDIA_IMAGES : Manifest.permission.READ_EXTERNAL_STORAGE)) {
            readLocalMedia();
        } else {
            PermissionChecker.requestPermissions(this, Build.VERSION.SDK_INT >= 33 ? new String[]{Manifest.permission.READ_MEDIA_IMAGES} : new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE);
        }
    }
