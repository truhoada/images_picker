...
import ucrop.callback.OverlayViewChangeListener;
...
public class OverlayView extends View {
     ...
     * @param before
     */
    private void cropSizeChangedAnim(final RectF before) {
        final float diffX = mCropViewRect.left - before.left;
        final float diffY = mCropViewRect.top - before.top;
